...
import g from './TypeScript.tmLanguage.json';

const NO_BANG = "(?<!\\!)"; // negative look behind to escape some chars - e.g. !<
...
function main() {
    ...
    fs.writeFileSync(path.join(__dirname, "xjs.tmLanguage.json"), newContent);
}
